/* =====================================================================
   ...
   Site settings → Environment variables):
     ...
     RESEND_FROM      Verified sender, e.g.
                      "Workflow Adoption Lab <reports@yourdomain.com>"
   Optional:
  ...
  return (
    ...
    '<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border:1px solid ' + LINE + ';border-radius:14px;overflow:hidden;">' +
      ...
      '<tr><td style="background:' + SAGE + ';padding:26px 32px;">' +
        '<div style="font:700 11px Arial,sans-serif;letter-spacing:2px;color:' + SOFT + ';text-transform:uppercase;">Workflow Adoption Lab</div>' +
      ...
      '<tr><td style="padding:18px 32px 28px;border-top:1px solid ' + LINE + ';">' +
        '<p style="margin:0;font:400 12px Arial,sans-serif;line-height:1.6;color:' + MUTED + ';">Generated by Workflow Adoption Lab. Want to run this conversation with your team? <a href="' + kit + '" style="color:' + SAGE + ';">Get the full AI Adoption Workshop Kit</a>.</p>' +
      "</td></tr>" +
