/* =====================================================================
   AI Adoption Readiness Scorecard — AiDopt
   ---------------------------------------------------------------------
...
(function () {
    ...
    return (
      '<div class="card card--soft sc-email" id="scEmailCard">' +
        ...
        '<form id="scEmailForm" novalidate>' +
          ...
          "</div>" +
          '<label class="sc-consent"><input type="checkbox" id="sc-consent"> <span>Email me my report and occasional, practical AI adoption resources from AiDopt. I can unsubscribe anytime.</span></label>' +
  ...
  function exportPdf() {
    ...
    for (let i = 1; i <= pages; i++) {
      ...
      doc.text("Generated by AiDopt — Want to run this conversation with your team? Get the full AI Adoption Workshop Kit.", M, 293, { maxWidth: pageW - M * 2 });
    }
  ...
  function printableFallback() {
    ...
    w.document.write(
      ...
      "<footer>Generated by AiDopt — Want to run this conversation with your team? Get the full AI Adoption Workshop Kit: " + h(KIT_CTA_URL) + "</footer>" +
